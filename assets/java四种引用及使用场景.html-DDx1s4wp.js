import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as t,f as i}from"./app-B6plLX71.js";const r={},a=i(`<ul><li><p>强引用（Strong Reference）：只要强引用在，即使在内存不足，也不会被回收。常见：创建新对象</p></li><li><p>软引用（SoftReference）:内存不足时会被回收。用于实现对内存敏感的高速缓存</p></li><li><p>弱引用（WeakReference）:只能生存到下一次垃圾回收之前，gc回收器发现它，就会被回收，用于引用占用内存空间较大的对象</p></li><li><p>虚引用（PhantomReference）:一个对象是否有虚引用存在，完全不会对其生存时间构成影响，也无法通过虚引用来取得对象实例，设置虚引用唯一目的能在这个对象被回收时收到一个系统通知</p></li></ul><p>虚引用示例</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>   void testPhantomReference(){
