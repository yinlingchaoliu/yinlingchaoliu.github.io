import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c as i,f as l}from"./app-B6plLX71.js";const s={},a=l(`<h4 id="_1、定义" tabindex="-1"><a class="header-anchor" href="#_1、定义"><span>1、定义</span></a></h4><p><code>单例模式：确保一个类只有一个实例，提供一个全局访问点 </code></p><h4 id="单例6种写法" tabindex="-1"><a class="header-anchor" href="#单例6种写法"><span>单例6种写法</span></a></h4><h5 id="_1、饿汉式" tabindex="-1"><a class="header-anchor" href="#_1、饿汉式"><span>1、饿汉式</span></a></h5><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>/**
 *
 * 饿汉式单例
 * @author chentong
 * 非线程安全
