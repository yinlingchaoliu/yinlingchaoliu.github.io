import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as t,c as n,f as a}from"./app-B6plLX71.js";const i={},l=a(`<p>####温故知新 将好的用法记录下来 流水账式记录</p><p>kotlin哲学 实用、精简、安全</p><p>原则：(DRY) Don\`t Repeat Yourself</p><p>表达主体</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>fun max(a:Int, b:Int):Int = if(a&gt;b) a else b
